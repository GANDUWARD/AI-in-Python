...
def check(a, b, avg):          #检验函数
    with open('C:\\Users\\pc\\Desktop\\py\\线性回归\\train.txt') as train_place:
...
def final_show(x_1, y_1, x_2, y_2, y_0, a, b):     #展示函数
    X_sum = []
    Y_sum = []
    Y = []
...
with open('C:\\Users\\pc\\Desktop\\py\\线性回归\\test.txt') as fp:
